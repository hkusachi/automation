...
public class NDM_TestCase2616DeviceRestart extends NDM_BaseSeleniumTest
{
    ...
    public void testPage() throws InterruptedException
    {
        try
        {
            ...
            test = extentCommon.createTest("2616DeviceRestart", "NDM_TestCase2616DeviceRestart");
            ...
            String taskName = devicePropertiesPage.RestartDevice(NDM_Core.Restart.Type.TypeDevice);
